...
import static modthedd.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("DD"); //This should match whatever you have in the CharacterStrings.json file
