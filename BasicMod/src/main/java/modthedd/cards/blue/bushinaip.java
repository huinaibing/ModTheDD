...
public class bushinaip extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "bushinaip", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int UPG_BLK = 5;
