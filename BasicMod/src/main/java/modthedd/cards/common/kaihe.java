...
public class kaihe extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "kaihe", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, p, new FrailPower(m, this.magicNumber, false)));
