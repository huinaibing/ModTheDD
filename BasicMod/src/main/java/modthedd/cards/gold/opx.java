...
public class opx extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "opx", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
