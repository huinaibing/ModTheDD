...
public class shoumi extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "shoumi", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
...
//    private static final int UPG_DRAW_CARD = 0;
    ...
    private static final int GAIN_MONEY = 10;
    private static final int UPG_GAIN_MONEY = 5;
    ...
    public void upgrade()
    {
        if (!upgraded) {
            this.upgradeName();
            this.upgradeMagicNumber(UPG_GAIN_MONEY);
        }
    }
